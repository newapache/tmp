...
<html>
   ...
   <head>
      ...
      <link rel="stylesheet" href="${pageContext.request.contextPath}/css/bookinglogin.css">
   </head>
         ...
         <div class="_view_content" ui-view="content" id="container" >
            <booked-confirm>
               <div class="booking_login">
                  ...
                  <!---->
                  <div>
                     <form name="confirm_form" class="ng-pristine ng-valid" id="form1" method="post" action="confirm" onSubmit="return validateEmail()">
                        ...
                        <div class="login_form"> 
                           ...
                           <input type="text" class="login_input ng-pristine ng-untouched ng-valid ng-empty" id="resrv_id" name="resrv_email" aria-invalid="false" placeholder="crong@naver.com" title="예매자이메일" onkeyup="validateEmail();">  </div>
                      	   <span class="wrong_msg" style="color:red; display: none;"> 이메일 형식 오류 </span>
