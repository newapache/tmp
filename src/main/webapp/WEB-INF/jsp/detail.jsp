...
<body>
	...
	<div id="container">
		<div class="header fade">
			<header class="header_tit">
				<h1 class="logo">
					<a href="${pageContext.request.contextPath}/main" class="lnk_logo"
						title="네이버"> <span class="spr_bi ico_n_logo">네이버</span>
					</a> <a href="${pageContext.request.contextPath}/main" class="lnk_logo"
						title="예약"> <span class="spr_bi ico_bk_logo">예약</span>
					</a>
				</h1>
				<a href="${pageContext.request.contextPath}/bookinglogin" class="btn_my"> <span title="예약확인">예약확인</span>
				</a>
			</header>
		</div>
		...
		<div class="ct main">
			<div>
				<div class="section_visual">
					<header>
						<h1 class="logo">
							<a href="${pageContext.request.contextPath}/main"
								class="lnk_logo" title="네이버"> <span
								class="spr_bi ico_n_logo">네이버</span>
							</a> <a href="${pageContext.request.contextPath}/main"
								class="lnk_logo" title="예약"> <span
								class="spr_bi ico_bk_logo">예약</span>
							</a>
						</h1>
						<a href="${pageContext.request.contextPath}/bookinglogin" class="btn_my"> <span
							class="viewReservation" title="예약확인"><br>예약확인</span>
						</a>
					</header>
					...
					<div class="pagination">
						...
						<div class="figure_pagination">
							<span id="page1" class="num">1</span>
							<span id="page2" class="num off">/ <span>2</span></span>
						</div>
					</div>
						...
						<div>
							<div class="container_visual" style="width: 414px;">
								...
								<ul class="visual_img detail_swipe">
									...
									<img alt="main_img" class="img_thumb" src="${pageContext.request.contextPath}/displayByName?name=${maImageName}">
									...
									<li class="item" style="width: 414px;">
									<img id="et_img" alt="etc_img" class="img_thumb" src="">
									<span class="img_bg"></span>
										<div class="visual_txt">
											<div class="visual_txt_inn">
												<h2 class="visual_txt_tit">
							...
							<div class="nxt">
								<div class="nxt_inn">
									<a href="#" class="btn_nxt" title="다음"> <i
										class="spr_book2 ico_arr6_rt off"></i>
									</a>
								</div>
							</div>
						</div>
				...
				<div class="section_store_details">
					...
					<a class="bk_more _close" style="display: none;"> <span class="bk_more_txt">접기</span>
						<i class="fn fn-up2"></i>
					</a>
				</div>
				...
				<div class="section_btn">
					<button onclick="location.href='${pageContext.request.contextPath}/reserve?id=${displayInfoId}'" type="button" class="bk_btn" >
				...
				<div class="section_review_list">
						...
						<div class="short_review_area">
							<div class="grade_area">
								...
								<span class="graph_mask"> <em class="graph_value"
									style="width: 0%;"></em>
								</span> <strong class="text_value"> <span id="average_score"></span> <em
									class="total">5.0</em>
								</strong> <span class="join_count"><em class="green" id="total_comment_cnt"></em> 등록</span>
							</div>
					...
					<a class="btn_review_more" href="${pageContext.request.contextPath}/review?id=${displayInfoId}"> <span>예매자
				...
				<div class="section_info_tab">
					...
					<ul class="info_tab_lst">
						<li class="item active _detail"><a class="anchor active"><span
								id="detail_span">상세정보</span></a></li>
						<li class="item _path"><a class="anchor"><span
								id="location_span">오시는길</span></a></li>
					</ul>
									...
									<div>
										<div class="review_area">
											...
											<div class="thumb_area">
                                     		 ...
                                     		 <img width="90" height="90" class="img_vertical_top" src="${pageContext.request.contextPath}/displayByName?name={{commentImg}}" alt="review_img">
	...
	<script type="location_template" id="detail_Info">
								...
								<ul class="detail_info_group">
									...
									<li class="detail_info_lst"><strong class="in_tit">[공지사항]</strong>
										<ul class="in_img_group">
											<li class="in_img_lst"><img alt="img_main" class="img_thumb"
