...
<body>
	<input type="hidden" id="reservationDate" value="${reservationDate}">
    ...
    <div id="container">
        ...
        <div class="header fade">
            <header class="header_tit">
                ...
                <a href="${pageContext.request.contextPath}/jsp/bookinglogin.jsp" class="btn_my"> <span title="예약확인">예약확인</span> </a>
            </header>
        </div>
        <div class="ct">
            <div class="ct_wrap">
                <div class="top_title">
                    <a href="${pageContext.request.contextPath}/main" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
                    <h2><span class="title"></span></h2>
                </div>
                <div class="group_visual">
                    <div class="container_visual" style="width: 414px;">
                        <ul class="visual_img">
                            <li class="item" style="width: 414px;"> <img alt="main_img" class="img_thumb" src="${pageContext.request.contextPath}/displayByName?name=${maImageName}"> <span class="img_bg"></span>
                ...
                <div class="section_store_details">
                    <div class="store_details">
                        ...
                        <p class="dsc" id="time_dsc">              
                        </p>
                        <h3 class="in_tit">요금</h3>
                        <p class="dsc" id="price_dsc">
                        </p>
                    </div>
                </div>
                        ...
                        <div class="form_wrap">
                            ...
                            <form class="form_horizontal">
                                <div class="inline_form"> <label class="label" for="name"> <span class="spr_book ico_nessasary">필수</span> <span>예매자</span> </label>
                                    ...
                                    <input type="text" name="name" id="name" class="text" placeholder="네이버" maxlength="17" onkeyup="validate.validateName();">
                                ...
                                <div class="inline_form"> <label class="label" for="tel"> <span class="spr_book ico_nessasary">필수</span> <span>연락처</span> </label>
                                    <div class="inline_control tel_wrap">
                                        <input type="tel" name="tel" id="tel" class="tel" value="" placeholder="휴대폰 입력 시 예매내역 문자발송" onkeyup="validate.validateTel();">
                                ...
                                <div class="inline_form"> <label class="label" for="email">  <span class="spr_book ico_nessasary">필수</span>  <span>이메일</span> </label>
                                    <div class="inline_control email_wrap">
                                    	<input type="email" name="email" id="email" class="email" value="" placeholder="crong@codesquad.kr" maxlength="50" onkeyup="validate.validateEmail();">
	...
	<script type="location_template" id="price_info">
			           <div class="qty">
                            ...
                            <div class="qty_info_icon"> <strong class="product_amount"> <span>{{priceType}}석 </span> </strong> <strong class="product_price"> <span class="price">{{price}}</span> <span class="price_type">원</span> </strong> <em class="product_dsc">{{price}}원 ({{discountRate}}% 할인가)</em> </div>
                      </div>
    </script>
</body>
</html>