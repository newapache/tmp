...
<body>
	...
	<div id="container">
		<div class="header">
			<header class="header_tit">
				<h1 class="logo">
					<a href="${pageContext.request.contextPath}/main" class="lnk_logo" title="네이버"> <span class="spr_bi ico_n_logo">네이버</span> </a>
		...
		<div class="ct">
			<div class="section_my">
				...
				<div class="my_summary">
					<ul class="summary_board">
						<li class="item">
							...
							<a href="#" class="link_summary_board on"> <i class="spr_book2 ico_book2"></i> <em class="tit">전체</em> <span id="book_total" class="figure">0</span> </a>
						</li>
						<li class="item">
							<a href="#" class="link_summary_board"> <i class="spr_book2 ico_book_ss"></i> <em class="tit">이용예정</em> <span id="book_reserved" class="figure">0</span> </a>
						</li>
						<li class="item">
							<a href="#" class="link_summary_board"> <i class="spr_book2 ico_check"></i> <em class="tit">이용완료</em> <span id="book_used" class="figure">0</span> </a>
						</li>
						<li class="item">
							<a href="#" class="link_summary_board"> <i class="spr_book2 ico_back"></i> <em class="tit">취소·환불</em> <span id="book_canceled" class="figure">0</span> </a>
						</li>
					</ul>
				</div>
				<!--// 예약 현황 -->
				...
				<div class="wrap_mylist">
					...
					<ul class="list_cards" style="display:none;">
									...
									<div class="card_body">
										...
										<div class="middle">
											<div class="card_detail">
												No.<em class="booking_number">0000001</em>
		...
		<div class="popup_booking_wrapper" style="display:none;">
			...
			<div class="popup_booking refund">
				...
				<div class="pop_bottom_btnarea">
					...
					<div class="btn_green">
						<a href="#" class="btn_bottom" id="cancel_booking"><span>예</span></a>
					</div>
				</div>
				<!-- 닫기 -->
	...
	<script src="${pageContext.request.contextPath}/js/myreservation.js"></script>
	<script type="location_template" id="card">		
									<a id={{reservationId}} class="link_booking_details">
										<div class="card_body">
											<div class="left"></div>
											<div class="middle">
												<div class="card_detail">
													No.<em class="booking_number">{{reservationId}}</em>
													<h4 class="tit">{{title}}</h4>
													<ul class="detail">
														<li id="date" class="item">
															<span class="item_tit">예매일</span>
													...
													<!-- [D] 예약 신청중, 예약 확정 만 취소가능, 취소 버튼 클릭 시 취소 팝업 활성화 -->
													<div class="booking_cancel" id="booking_cancel">
														<button class="btn"><span>취소</span></button>
													</div>
		...
		<script type="location_template" id="card_used">
										...
										<div class="card_body">
											...
											<div class="middle">
												<div class="card_detail">
													...
													<div class="booking_cancel">
														<a href="${pageContext.request.contextPath}/reviewWrite?reservationInfoId={{reservationId}}"><button class="btn"><span>예매자 리뷰 남기기</span></button></a>
													</div>
												</div>
											</div>
											<div class="right"></div>
		...
		<script type="location_template" id="card_canceled">
									<a class="link_booking_details">
										<div class="card_body">
											<div class="left"></div>
											<div class="middle">
