...
<body>
	...
	<div id="container">
		<div class="header">
			<header class="header_tit">
				...
				<c:choose>
				    <c:when test="${sessionScope.hasEmail == 'true'}">
				        		<a href="${pageContext.request.contextPath}/myreservation" class="btn_my">
								<span class="viewReservation">${email}</span>
								</a><br><br>
				    </c:when>
				    <c:otherwise> 
		...
		<div class="event">
			...
			<div class="section_event_tab">
				<ul class="event_tab_lst tab_lst_min">
					...
					<li class="item" data-category="5"><a class="anchor"> <span>연극</span></a></li>
				</ul>
			</div>
			...
			<div class="section_event_lst">
				...
				<div class="wrap_event_box">
					...
					<ul class="lst_event_box" id="left_event_box"></ul>

					<ul class="lst_event_box" id="right_event_box"></ul>
	...
	<script type="rv-template" id="promotionItem">
		<li class="item" style="background-image: url(${pageContext.request.contextPath}/displayByName?name={productImageUrl});">
	...
	<script type="rv-template" id="itemList">
        <li class="item">
            <a href="${pageContext.request.contextPath}/detail?id={id}" class="item_book">
                <div class="item_preview">
                    <img alt="none" class="img_thumb" src="${pageContext.request.contextPath}/displayByName?name={img}">
