...
<body>
	...
	<div id="container">
		...
		<div class="ct">
			<div class="ct_wrap">
				<form enctype="multipart/form-data" method="post" name="fileinfo" onsubmit="return false">
				...
				<div class="write_act">
					...
					<div class="review_rating rating_point">
						<div class="rating">
							...
							<input type="checkbox" name="rating2" data-value="1" class="rating_rdo" title="1점">
							<span class="span"></span>
							<input type="checkbox" name="rating3" data-value="2" class="rating_rdo" title="2점">
							<span class="span"></span>
							<input type="checkbox" name="rating4" data-value="3" class="rating_rdo" title="3점" >
							<span class="span"></span>
							<input type="checkbox" name="rating5" data-value="4" class="rating_rdo" title="4점">
							<span class="span"></span>
							<input type="checkbox" name="rating6" data-value="5" class="rating_rdo" title="5점">
							<span class="span"></span>
							<!-- [D] 0점일 때 gray_star 추기 -->
							<span class="star_rank gray_star"> 0</span>
							<input type="hidden" name="score" id="star_rating">
						</div>
					</div>
				</div>
				<!-- //리뷰 별점 -->
				...
				<div class="review_contents write">
					...
					<textarea cols="30" rows="10" class="review_textarea" maxlength="400" name="comment" required></textarea>
				</div>
				<!-- //리뷰 입력 -->
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<input type="file" class="hidden_input" id="reviewImageFileOpenInput" name="file" required/>
						<!-- <input type="file" id="reviewImageFileOpenInput" name="file" /> -->
						<!--<input type="file" class="hidden_input" id="reviewImageFileOpenInput" accept="image/*" multiple>-->
						<div class="guide_review">
							<span class="result">0</span>/400
							<span>(최소5자이상)</span>
						</div>
					</div>
						...
						<div class="item_preview_thumbs">
							<ul class="lst_thumb">
								<li class="item" style="display: none;">
									...
									<img src="http://naverbooking.phinf.naver.net/20170306_3/1488772023601A4195_JPEG/image.jpg?type=f300_300" width="130" alt="thumb" class="item_thumb">
				...
				<div class="box_bk_btn">
					<input class="bk_btn" type="submit" value="리뷰 등록" />
				</div>
				<!-- //리뷰 등록 -->
	...
	<script src="${pageContext.request.contextPath}/js/reviewWrite.js"></script>
</body>
</html>